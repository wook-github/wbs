...
Pager.prototype = {
	...
	setBtnDisplay : function(){
		...
		if(groupNo == 1){ // 첫 번째 페이지 선택한 경우
			...
			$("#firstBtn" + this.num).attr("src", wook.wbs.common.contextPath + "/resources/images/page/firstOn.gif");
			$("#prevBtn" + this.num).attr("src",  wook.wbs.common.contextPath + "/resources/images/page/prevOn.gif");
		...
		if(groupNo == maxGroupNo){
			...
			$("#nextBtn" + this.num).attr("src", wook.wbs.common.contextPath + "/resources/images/page/nextOn.gif");
			$("#lastBtn" + this.num).attr("src", wook.wbs.common.contextPath + "/resources/images/page/lastOn.gif");
